...
const ArfajCampaign = () => {
    ...
    return (
        <section id="arfaj-campaign" className="py-20 bg-gradient-to-b from-white to-blue-50/40 border-y border-blue-100/60">
            <div className="container mx-auto px-4">
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-3xl md:text-5xl font-black text-accent leading-tight">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-2 bg-primary hover:bg-sky-600 text-white font-bold px-6 py-3 rounded-xl transition-colors"
                        >
